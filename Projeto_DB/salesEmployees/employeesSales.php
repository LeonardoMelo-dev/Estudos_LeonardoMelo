...
$sql = "SELECT * FROM employees_sales";
...
<body>
  <table class="table">
    <thead style="background-color: black;">
      <tr>
        <th style="color: white">Nome (Fun)</th>
        <th style="color: white">Sobrenome (Fun)</th>
        <th style="color: white">E-mail (Fun)</th>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <form action="storeSales.php" method="POST">
              ...
              <label for="fk_employee_id">Número do funcionário</label><br>
              <input type="text" id="fk_employee_id" name="fk_employee_id"><br>
