...
<head>
    ...
    <link  rel="stylesheet" href="css - TimeLine/bootstrap.mim.css">
    <script src="css - TimeLine/boottrap.min.js"></script>
    <script src="css - TimeLine/jquery.min.js"></script>
    <link rel="stylesheet" href="css - TimeLine/comum.css">
    <link rel="stylesheet" href="css - TimeLine/bootstrap.min.css">
    <title>Hackton</title>
</head>
<body>       
                    ...
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="ml-2">
                                    <div class="h5 m-0"><?= $_SESSION['user']->firstName ?></div>
